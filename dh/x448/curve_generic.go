...
func (c *curve) ladderStep(w *[5]fp448.Elt, b uint) {
...
func (c *curve) mulA24(z, x *fp448.Elt) {
	const A24 = 39082
	const n = 8
	var xx [7]uint64
	for i := range xx {
...
func (c *curve) double(x, z *fp448.Elt) {
...
func (c *curve) difAdd(w *[5]fp448.Elt, b uint) {
