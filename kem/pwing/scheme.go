...
// This file contains the boilerplate code to connect P-Wing to the
// generic KEM API.

// Returns the generic KEM interface for  P-Wing PQ/T hybrid KEM.
func Scheme() kem.Scheme { return scheme{} }

type scheme struct{}

func (scheme) Name() string               { return "P-Wing" }
...
func (sk *PrivateKey) Equal(other kem.PrivateKey) bool {
	...
	return sk.m.Equal(&oth.m) && oth.x.Equal(sk.x)
}
...
func (pk *PublicKey) Equal(other kem.PublicKey) bool {
	...
	return pk.m.Equal(&oth.m) && pk.x.Equal(oth.x)
}
