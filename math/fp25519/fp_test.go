...
func TestGeneric(t *testing.T) {
	testCmov(t, cmovGeneric)
	testCswap(t, cswapGeneric)
	testAdd(t, addGeneric)
	testSub(t, subGeneric)
	testAddSub(t, addsubGeneric)
	testMul(t, mulGeneric)
	testSqr(t, sqrGeneric)
	testModp(t, modpGeneric)
}
