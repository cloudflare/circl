...
// func ladderStepLeg448(wbuf []byte, move uint)
...
TEXT ·ladderStepLegX448(SB),NOSPLIT,$0
    MOVQ wbuf+0(FP), regWork
    MOVQ move+24(FP), regMove
    ladderStepLeg()
    RET

// func ladderStepBmi2Adx448(wbuf []byte, move uint)
// wbuf contains variables used in the Montgomery's ladder step,
// where {x1,x2,z2,x3,z3,t0,t1} are seven field.Element of field.Size bytes, and
//       {b0,b1} are two field.bigElement of 2*field.Size bytes.
TEXT ·ladderStepBmi2AdxX448(SB),NOSPLIT,$0
    MOVQ wbuf+0(FP), regWork
    MOVQ move+24(FP), regMove
    ladderStepBmi2Adx()
    RET
...
//       {b0,b1} are two field.bigElement of 2*field.Size bytes.
TEXT ·difAdditionLegX448(SB),NOSPLIT,$0
    MOVQ wbuf+0(FP), regWork
    MOVQ mu+24(FP), regMu
...
// where {x1,z1,x2,z2} are four field.Element of field.Size bytes, and
//       {b0,b1} are two field.bigElement of 2*field.Size bytes.
TEXT ·difAdditionBmi2AdxX448(SB),NOSPLIT,$0
    MOVQ wbuf+0(FP), regWork
    MOVQ mu+24(FP), regMu
    MOVQ swap+48(FP), regSwap
    difAdditionBmi2Adx()
...
// where {x1,z1,x2,z2} are four field.Element of field.Size bytes, and
//       {b0,b1} are two field.bigElement of 2*field.Size bytes.
TEXT ·doubleLegX448(SB),NOSPLIT,$0
    MOVQ wbuf+0(FP), regWork
    doubleLeg()
    RET

// func doubleBmi2AdxX448(wbuf *workJoye)
// wbuf contains variables used in the Joye's ladder step,
// where {x1,z1,x2,z2} are four field.Element of field.Size bytes, and
//       {b0,b1} are two field.bigElement of 2*field.Size bytes.
TEXT ·doubleBmi2AdxX448(SB),NOSPLIT,$0
    MOVQ wbuf+0(FP), regWork
    doubleBmi2Adx()
    RET
