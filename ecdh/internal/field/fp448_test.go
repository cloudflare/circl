...
func TestFp448(t *testing.T) {
	...
	t.Run("sub", func(t *testing.T) { genericTest448(t, &io, subt448) })
	...
	t.Run("div", func(t *testing.T) { genericTest448(t, &io, divd448) })
}

func BenchmarkFp448(b *testing.B) {
	var x, y, z Element448
	var io test448
	io.F = Fp448
