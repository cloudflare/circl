...
| Hybrid Public-Key Encryption | Base, Auth, PSK, AuthPSK | [HPKE](https://datatracker.ietf.org/doc/draft-irtf-cfrg-hpke) is a combination of KEM and Authenticated Encryption. | TLS |
